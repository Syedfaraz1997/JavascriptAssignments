...
//Gettimg element of id “main-content” and assigning them in a variable.
 ...
 ///Part 2 : Displaying all child elements of main content

 var c = document.body.children[0].children[2]
 console.log(c)

 ///Part 3 : Getting elements of class render and showing thier inner html
...
//Part 4 and 5 :  Filling input values using javascript

var val = document.getElementsByTagName("input")[0].setAttribute("value" , "Syed   Faraz Ali")

var val1 = document.getElementsByTagName("input")[1].setAttribute("value" , "Syed Ishtiaque Ali")
var val1 = document.getElementsByTagName("input")[2].setAttribute("value" , "syedfaraz210@gmail.com")


//*****************************************************************// 
//Question # 2

Q//uestion 2 Part # 1 : Nodetype of element havinf id form-content
...
//Part 3 : Update child node of element having id “lastName”.
